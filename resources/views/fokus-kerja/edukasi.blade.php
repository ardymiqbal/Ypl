...
<section class="bg-white rounded-2xl shadow p-4 sm:p-6 md:p-8">
  ...
  <h1 class="font-extrabold leading-tight text-grey-900 text-balance
  ...
  <div class="mt-4 overflow-hidden rounded-xl ring-1 ring-black/5">
    <img
      ...
      class="w-full h-56 sm:h-64 md:h-[28rem] lg:h-[34rem] xl:h-[40rem]
             object-cover object-[center_65%]"  {{-- fokus agak ke bawah --}}
    >
  </div>

  {{-- PARAGRAF PEMBUKA: font nyaman di HP, center, rapih --}}
