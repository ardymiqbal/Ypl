...
@section('content')
@php
  $hero = asset('images/action/relawan-hero.png');
@endphp
...
<section class="bg-white rounded-2xl shadow p-4 sm:p-6 md:p-8">
  <div class="grid md:grid-cols-12 gap-6 md:gap-8 items-center">
    ...
    <div class="md:col-span-7">
      ...
      <h1 class="mt-3 font-extrabold leading-tight text-red-900 text-balance
                 text-[clamp(22px,6vw,40px)] md:text-[clamp(28px,3.8vw,52px)]">
        Bergerak Bersama <br class="hidden md:block"/> Menjadi Relawan Lingkungan
      </h1>
      ...
      <a href="#form-relawan"
         class="inline-flex items-center gap-2 mt-5 px-5 py-2.5 rounded-lg bg-rose-600 text-white font-semibold
                hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-rose-500/50">
    ...
    <div class="md:col-span-5 flex justify-center md:justify-end">
      <div class="w-full md:w-[360px] lg:w-[400px] xl:w-[440px] md:max-w-none
                  overflow-hidden rounded-xl ring-1 ring-black/5 shadow">
        <img src="{{ $hero }}" alt="Relawan Lingkungan"
             class="w-full aspect-[4/5] sm:aspect-[3/4] object-cover">
      </div>
    </div>
...
<section class="mt-8 bg-white rounded-2xl shadow p-4 sm:p-6 md:p-8">
  <h2 class="text-grey-800 font-extrabold text-balance
  ...
  <div class="mt-4 grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
    {{-- Card 1 --}}
    <div class="rounded-xl ring-1 ring-rose-200 bg-white p-4 sm:p-5 h-full">
      <div class="flex items-center gap-2 text-rose-700 font-bold text-sm">
        <span class="grid place-items-center w-6 h-6 rounded-full bg-rose-50 text-rose-700 ring-1 ring-rose-200">1</span>
        Pendaftaran
      </div>
    ...
    <div class="rounded-xl ring-1 ring-rose-200 bg-white p-4 sm:p-5 h-full">
      <div class="flex items-center gap-2 text-rose-700 font-bold text-sm">
        <span class="grid place-items-center w-6 h-6 rounded-full bg-rose-50 text-rose-700 ring-1 ring-rose-200">2</span>
        Seleksi
      </div>
      <p class="mt-2 text-gray-700 text-[13px] sm:text-sm md:text-[15px] leading-6">
    ...
    <div class="rounded-xl ring-1 ring-rose-200 bg-white p-4 sm:p-5 h-full">
      <div class="flex items-center gap-2 text-rose-700 font-bold text-sm">
        <span class="grid place-items-center w-6 h-6 rounded-full bg-rose-50 text-rose-700 ring-1 ring-rose-200">3</span>
        Orientasi
      </div>
      <p class="mt-2 text-gray-700 text-[13px] sm:text-sm md:text-[15px] leading-6">
    ...
    <div class="rounded-xl ring-1 ring-rose-200 bg-white p-4 sm:p-5 h-full">
      <div class="flex items-center gap-2 text-rose-700 font-bold text-sm">
        <span class="grid place-items-center w-6 h-6 rounded-full bg-rose-50 text-rose-700 ring-1 ring-rose-200">4</span>
        Aksi Lingkungan
      </div>
      <p class="mt-2 text-gray-700 text-[13px] sm:text-sm md:text-[15px] leading-6">
...
<section class="mt-8">
  <h2 class="text-center font-bold text-gray-700 text-[13px] sm:text-sm md:text-base">
